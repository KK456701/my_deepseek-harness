...
import type { AccountBalanceView, ConfigurableProviderView, DiscoveredModelView } from './llm.ts'
...
/** AccountBalanceView row of llm.balance. */
export const accountBalanceViewSchema = z.object({
  currency: z.string().min(1),
  total: z.string().min(1),
  granted: z.string().min(1).optional(),
  toppedUp: z.string().min(1).optional(),
}) satisfies z.ZodType<Wire<AccountBalanceView>>
...
export const llmBalanceValueSchema = z.object({
  balances: z.array(accountBalanceViewSchema),
