...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Choose cloud API models or local Ollama models for each conversation.',
  cloudModels: 'Cloud API models',
  cloudModelsDescription: 'Requests use the configured provider and its API credential.',
  ollamaModels: 'Local Ollama models',
  ollamaModelsDescription: 'Runs on this computer through Ollama; no cloud API billing.',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '模型',
  title: '模型',
  intro: '可为每个会话选择云端 API 模型或本机 Ollama 模型。',
  cloudModels: '云端 API 模型',
  cloudModelsDescription: '请求会使用已配置提供方及其 API 凭据。',
  ollamaModels: '本地 Ollama 模型',
  ollamaModelsDescription: '通过本机 Ollama 运行，不产生云端 API 费用。',
  edit: '编辑',
