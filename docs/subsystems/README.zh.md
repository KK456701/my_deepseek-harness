...
| [memory.md](memory.md) | profile 长期记忆 Service、两阶段 maintenance、不可变 generation、provenance、prompt 快照和控制 |
...
| [task-contract-final-gate.md](task-contract-final-gate.md) | 持续保留的任务需求与已确认计划、冻结交付审查、有界补救和共享执行控制 |
