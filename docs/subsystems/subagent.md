...
<a id="ctxcodexstructuredrunner--codexstructuredrunner-abstract-seam"></a>

### `ctx.codexStructuredRunner` — `CodexStructuredRunner` (abstract seam)
...
Source: [`packages/subagent/codex-structured-runner/src/index.ts:35`](../../packages/subagent/codex-structured-runner/src/index.ts)
