...
export const SERVICE_PAGE: Record<string, string> = {
  progressIntegrityObserver: 'task-contract-final-gate.md',
  taskContract: 'task-contract-final-gate.md',
  taskExecutionControl: 'task-contract-final-gate.md',
  agentLoop: 'core.md',
  ...
  codexStructuredRunner: 'subagent.md',
  ...
  lsp: 'lsp.md',
  memory: 'memory.md',
  memoryMaintenance: 'memory.md',
  memoryPipelineStore: 'memory.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  profilePath: 'not a service: boot-provided active-profile path resolver for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  Agent: 'core.md',
  AssistantDeliveryDecision: 'core.md',
  AssistantCandidateFinish: 'core.md',
  FinalCandidateDecision: 'core.md',
  AssistantMessage: 'llm-streaming.md',
  ...
  TaskInputRecord: 'task-contract-final-gate.md',
  TaskExecutionSnapshot: 'task-contract-final-gate.md',
  TaskExecutionMode: 'task-contract-final-gate.md',
  PendingTaskOperation: 'task-contract-final-gate.md',
  RecoveryProbe: 'task-contract-final-gate.md',
  PlanApprovalObserver: 'plan.md',
  PlanApprovalRequest: 'plan.md',
  ...
  AdHocNote: 'memory.md',
  AdHocNoteListRequest: 'memory.md',
  AdHocNotePage: 'memory.md',
  MaintenanceSessionBinding: 'memory.md',
  MaterializingGeneration: 'memory.md',
  MemoryFailureDisposition: 'memory.md',
  MemoryFailureRecord: 'memory.md',
  MemoryGenerationId: 'memory.md',
  MemoryLease: 'memory.md',
  MemoryMaintenanceRun: 'memory.md',
  MemoryProfileState: 'memory.md',
  MemoryRebuild: 'memory.md',
  StartCleanPolicyRebuildRequest: 'memory.md',
  CleanRebuildDiscoveryProgress: 'memory.md',
  StructuredConsolidationInput: 'memory.md',
  MemoryAttemptId: 'memory.md',
  Phase2StructuredRequest: 'memory.md',
  Phase2StructuredResult: 'memory.md',
  MemoryProfileControlPatch: 'memory.md',
  MemoryItemListRequest: 'memory.md',
  MemoryItemPage: 'memory.md',
  RememberMemoryRequest: 'memory.md',
  UpdateMemoryItemRequest: 'memory.md',
  DeleteMemoryItemRequest: 'memory.md',
  MemoryRuntimeSettings: 'memory.md',
  MemoryRuntimeSettingsPatch: 'memory.md',
  MemoryRuntimeSettingsValues: 'memory.md',
  MemoryPromptSnapshot: 'memory.md',
  MemoryPromptSnapshotResult: 'memory.md',
  MemoryPromptSnapshotRequest: 'memory.md',
  MemoryListRequest: 'memory.md',
  MemoryReadRequest: 'memory.md',
  MemorySearchHit: 'memory.md',
  MemorySearchRequest: 'memory.md',
  MemoryPruneRequest: 'memory.md',
  MemoryPruneResult: 'memory.md',
  MemoryQuotaQuery: 'memory.md',
  MemoryQuarantineListRequest: 'memory.md',
  MemoryQuarantinePage: 'memory.md',
  MemoryReadLeaseId: 'memory.md',
  MemoryRecoveryResult: 'memory.md',
  MemoryTreePage: 'memory.md',
  MemoryTreeRequest: 'memory.md',
  MemoryFileReadRequest: 'memory.md',
  MemoryFileReadResult: 'memory.md',
  MemoryWakeReason: 'memory.md',
  Phase1Attempt: 'memory.md',
  Phase1Claim: 'memory.md',
  Phase1ClaimRequest: 'memory.md',
  Phase1Outcome: 'memory.md',
  Phase2Claim: 'memory.md',
  Phase2ClaimRequest: 'memory.md',
  Phase2Workspace: 'memory.md',
  PreparedGeneration: 'memory.md',
  PrepareGenerationRequest: 'memory.md',
  PublishedGeneration: 'memory.md',
  PublishGenerationRequest: 'memory.md',
  QuarantineRangeId: 'memory.md',
  RecordedPhase1Request: 'memory.md',
  RecordedPhase1Result: 'memory.md',
  RegisterSourceRange: 'memory.md',
  RegisterSourceRangeResult: 'memory.md',
  RenewMemoryLeaseRequest: 'memory.md',
  SessionMemoryControls: 'memory.md',
  SessionMemoryControlsPatch: 'memory.md',
  SubmitConversationMemoryRequest: 'memory.md',
  SubmitAdHocNoteRequest: 'memory.md',
  ResetMemoryRequest: 'memory.md',
  ...
  LlmBalanceRequest: 'llm-streaming.md',
  ...
  CodexStructuredCallRequest: 'subagent.md',
  PreparedCodexStructuredCall: 'subagent.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  RequirementInputRecord: 'experimental admitted-input record is owned by docs/subsystems/task-contract-final-gate.md',
  RequirementUpdate: 'experimental requirement update is owned by docs/subsystems/task-contract-final-gate.md',
  TaskContractSnapshot: 'experimental requirement snapshot is owned by docs/subsystems/task-contract-final-gate.md',
